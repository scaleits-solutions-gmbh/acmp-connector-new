...
import { FindJobByIdIn } from 'acmp-connector-bounded-context/application/ports/primary/jobs/queries/find-job-by-id/find-job-by-id.in';
import { FindJobByIdOut } from 'acmp-connector-bounded-context/application/ports/primary/jobs/queries/find-job-by-id/find-job-by-id.out';
import { FindJobByIdQueryPrimaryPort } from 'acmp-connector-bounded-context/application/ports/primary/jobs/queries/find-job-by-id/find-job-by-id.query.port';
