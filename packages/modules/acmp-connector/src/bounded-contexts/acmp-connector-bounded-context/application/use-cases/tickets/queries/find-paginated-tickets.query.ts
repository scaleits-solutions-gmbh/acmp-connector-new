...
import { FindPaginatedTicketsIn } from 'acmp-connector-bounded-context/application/ports/primary/tickets/queries/find-paginated-tickets/find-paginated-tickets.in';
import { FindPaginatedTicketsOut } from 'acmp-connector-bounded-context/application/ports/primary/tickets/queries/find-paginated-tickets/find-paginated-tickets.out';
import { FindPaginatedTicketsQueryPrimaryPort } from 'acmp-connector-bounded-context/application/ports/primary/tickets/queries/find-paginated-tickets/find-paginated-tickets.query.port';
