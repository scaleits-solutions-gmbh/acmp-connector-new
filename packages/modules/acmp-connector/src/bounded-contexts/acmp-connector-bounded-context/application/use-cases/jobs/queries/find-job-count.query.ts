...
import { FindJobCountIn } from 'acmp-connector-bounded-context/application/ports/primary/jobs/queries/find-job-count/find-job-count.in';
import { FindJobCountOut } from 'acmp-connector-bounded-context/application/ports/primary/jobs/queries/find-job-count/find-job-count.out';
import { FindJobCountQueryPrimaryPort } from 'acmp-connector-bounded-context/application/ports/primary/jobs/queries/find-job-count/find-job-count.query.port';
