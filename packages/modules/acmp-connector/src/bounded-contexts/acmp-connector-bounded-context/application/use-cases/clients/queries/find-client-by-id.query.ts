...
import { FindClientByIdIn } from 'acmp-connector-bounded-context/application/ports/primary/clients/queries/find-client-by-id/find-client-by-id.in';
import { FindClientByIdOut } from 'acmp-connector-bounded-context/application/ports/primary/clients/queries/find-client-by-id/find-client-by-id.out';
import { FindClientByIdQueryPrimaryPort } from 'acmp-connector-bounded-context/application/ports/primary/clients/queries/find-client-by-id/find-client-by-id.query.port';
