import { RolloutTemplateQueryRepositorySecondaryPort, FindPaginatedRolloutTemplatesFilters } from '@repo/modules/acmp-connector';
...
export class MssqlRolloutTemplateQueryRepository extends BaseSpi implements RolloutTemplateQueryRepositorySecondaryPort {
   ...
   */
  async findPaginatedRolloutTemplates(pagination: PaginationOption, filters?: FindPaginatedRolloutTemplatesFilters): Promise<PaginatedData<AcmpRolloutTemplateListItemReadModel>> {
