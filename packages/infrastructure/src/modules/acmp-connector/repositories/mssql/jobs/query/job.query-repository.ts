...
import { JobQueryRepositorySecondaryPort, FindPaginatedJobsFilters } from '@repo/modules/acmp-connector';
...
export class MssqlJobQueryRepository extends BaseSpi implements JobQueryRepositorySecondaryPort {
   ...
   */
  async findPaginatedJobs(pagination: PaginationOption, filters?: FindPaginatedJobsFilters): Promise<PaginatedData<AcmpJobReadModel>> {
