...
import { ClientCommandQueryRepositorySecondaryPort, FindPaginatedClientCommandsFilters } from '@repo/modules/acmp-connector';
...
export class MssqlClientCommandQueryRepository extends BaseSpi implements ClientCommandQueryRepositorySecondaryPort {
   ...
   */
  async findPaginatedClientCommands(pagination: PaginationOption, filters?: FindPaginatedClientCommandsFilters): Promise<PaginatedData<AcmpClientCommandReadModel>> {
