...
import { ClientQueryRepositorySecondaryPort, FindPaginatedClientsFilters } from '@repo/modules/acmp-connector';
...
export class MssqlClientQueryRepository extends BaseSpi implements ClientQueryRepositorySecondaryPort {
   ...
   */
  async findPaginatedClients(pagination: PaginationOption, filters?: FindPaginatedClientsFilters): Promise<PaginatedData<AcmpClientReadModel>> {
