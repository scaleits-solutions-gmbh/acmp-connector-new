import { ClientInstalledSoftwareQueryRepositorySecondaryPort, FindPaginatedClientInstalledSoftwareFilters } from '@repo/modules/acmp-connector';
...
export class MssqlClientInstalledSoftwareQueryRepository extends BaseSpi implements ClientInstalledSoftwareQueryRepositorySecondaryPort {
   ...
   */
  async findClientInstalledSoftwareCount(clientId: string, filters?: FindPaginatedClientInstalledSoftwareFilters): Promise<number> {
