import { ClientHardDriveQueryRepositorySecondaryPort } from '@repo/modules/acmp-connector';
...
export class MssqlClientHardDriveQueryRepository extends BaseSpi implements ClientHardDriveQueryRepositorySecondaryPort {
   ...
   */
  async findPaginatedClientHardDrives(clientId: string, pagination: PaginationOption): Promise<PaginatedData<AcmpClientHardDriveListItemReadModel>> {
