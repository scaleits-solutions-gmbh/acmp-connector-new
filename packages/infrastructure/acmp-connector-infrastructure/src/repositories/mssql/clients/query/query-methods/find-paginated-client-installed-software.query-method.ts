...
export async function findPaginatedClientInstalledSoftwareQueryMethod(clientId: string, pagination: PaginationOption, filters?: FindPaginatedClientInstalledSoftwareFilters): Promise<PaginatedData<AcmpClientInstalledSoftwareListItemReadModel>> {
