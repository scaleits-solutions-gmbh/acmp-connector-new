...
export default defineConfig({
  plugins: [
    tsconfigPaths({
      projects: [
        './tsconfig.e2e.json',
        r('../../../packages/business/bounded-contexts/acmp-connector-bounded-context/tsconfig.json'),
      ],
    }),
  ],
  resolve: {
    alias: {
      ...
      '@repo/business/boundaries': r('../../../packages/business/boundaries/src/index.ts'),
      // Boundaries depends on bounded-context types/value-objects at runtime.
      '@repo/business/bounded-contexts/acmp-connector-bounded-context': r(
