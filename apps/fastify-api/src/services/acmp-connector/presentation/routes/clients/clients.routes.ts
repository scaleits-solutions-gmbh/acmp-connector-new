...
import { createFindPaginatedClientsHandler } from "@/services/acmp-connector/presentation/handlers/clients/find-paginated-clients.handler";
import { createFindClientByIdHandler } from "@/services/acmp-connector/presentation/handlers/clients/find-client-by-id.handler";
import { createFindPaginatedClientHardDrivesHandler } from "@/services/acmp-connector/presentation/handlers/clients/find-paginated-client-hard-drives.handler";
import { createFindPaginatedClientNetworkCardsHandler } from "@/services/acmp-connector/presentation/handlers/clients/find-paginated-client-network-cards.handler";
import { createFindPaginatedClientInstalledSoftwareHandler } from "@/services/acmp-connector/presentation/handlers/clients/find-paginated-client-installed-software.handler";
...
export async function clientsRoutes(
  ...
  fastify.withTypeProvider<ZodTypeProvider>().route({
    ...
    handler: createFindPaginatedClientHardDrivesHandler(
  ...
  fastify.withTypeProvider<ZodTypeProvider>().route({
    ...
    handler: createFindPaginatedClientNetworkCardsHandler(
  ...
  fastify.withTypeProvider<ZodTypeProvider>().route({
    ...
    handler: createFindPaginatedClientInstalledSoftwareHandler(
