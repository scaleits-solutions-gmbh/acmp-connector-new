...
import type { FindPaginatedClientNetworkCardsQueryPrimaryPort } from "@repo/modules/acmp-connector";
...
export function createFindPaginatedClientNetworkCardsHandler(
  ...
  return async (request: FastifyRequest, reply: FastifyReply) => {
    const httpRequest =
      mapFastifyRequest<GetClientNetworkCardsHttpRequest>(request);
